...
class PilotView extends StateSwitcherGearHolderImpl<PilotViewScene> implements View
{
	...
	/* 入力補助 */
	private var viewSceneInputFactory:ViewSceneInputFactory;
	/* 基本レイヤー */
	...
	public function preparation(tool:GearPreparationTool):Void
	{
		...
		viewSceneInputFactory = new ViewSceneInputFactory(hook);
		tool.diffuse(viewSceneInputFactory, ViewSceneInputFactory);
	}
